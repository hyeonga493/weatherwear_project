...
<body>
	...
	<c:if test="${client != null}">
		<h2>회원 정보 수정</h2>
		<div class="password_check_info">
			<fieldset id="password_check_info">
				<legend><b>개인 정보 수정</b></legend>
				<form name="password_update" action="passwordCheck.do" method="POST">
					<input type="hidden" id="clientId" name="clientId" value="${ client.clientId }">
					<table class="password_check_table">
						<tr>
							<th class="password_check_title">현재 비밀번호 : </th>
							<td class="password_check_data">
