	...
	<div id="product_content">
		...
		<div class="products" style="margin-right:20px">
				<c:forEach var="product" items="${productList}">
					<ul class="product">
						<c:set var="main" value="${ product.mainImage }"/>
						<li><a href="productInfo.do?proId=${product.proId}"><img src="${ main.imageDir }${ main.imageName }" style="width:300px; height:400px;"></a></li>
