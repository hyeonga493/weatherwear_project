...
<div id="product_content">
	...
	<div class="table_div">
					...
					<tr class="products">
						...
						<!-- 체크박스 form -->
							<form method="get" name="order_form" id="order_form">
		      					<label><input type="checkbox" id="checked_cart" class="checkClass" name="checked_cart" value="${ CartDAO.caId }" >이미지</label>							</form>	
		...
		<input class="btn" type="button" value="계속 쇼핑하기" onclick="history_back()">
