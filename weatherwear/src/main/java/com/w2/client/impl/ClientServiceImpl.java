...
public class ClientServiceImpl implements ClientService {
	...
	public void findPwd(HttpServletResponse response, ClientVO client) throws Exception{
		...
		sendEmail(client, imsiPwd);
	}
	
	// 이메일 인증
	@Override
	public void sendEmail(ClientVO client, String imsiPwd) {
		// Mail Server 설정
		...
		msg += "<div align='center' style='border:1px solid black; font-family:verdana; width:80%; background-color:ivory;'><br><br><hr>";
